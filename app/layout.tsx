...
export default function RootLayout({
    ...
    return (
        <html lang="en">
            ...
            <body className={`${specialGothicExpandedOne.className} h-screen bg-[linear-gradient(0deg,rgb(0_0_0/90%),rgb(10_10_10/80%)),url(/images/background.jpg?v=1)] bg-cover bg-center overflow-hidden text-white`}>
                <Header />
